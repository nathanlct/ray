...
_OBJECTSTORESTATS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='consumed_bytes', full_name='ray.rpc.ObjectStoreStats.consumed_bytes', index=9,
      number=10, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='consumedBytes', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_UPDATERESOURCEUSAGEREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='serializedResourceUsageBatch', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
